...
with open("indexv.csv","w+") as fout:
    fout.write("\n".join(["previous_verse	previous_book	previous_chapter	next_verse	next_book	next_chapter"] + ["{}	{}	{}	{}	{}	{}".format(verseprev[i]+1,boookprev[i]+1,chaptprev[i]+1,versenext[i]+1,boooknext[i]+1,chaptnext[i]+1) for i in range(23213)]))
