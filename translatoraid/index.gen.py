...
["""<span id="toc"><a class="shadow" href="/translatoraid/"""+book.replace(" ","")+".html"+"""">""" +book+"</a></span>" for book in books[:5] ])+ """
</p></div>
...
["""<span id="toc"><a class="shadow" href="/translatoraid/"""+book.replace(" ","")+".html"+"""">""" +book+"</a></span>" for book in books[5:21] ])+ """
</p></div>
...
["""<span id="toc"><a class="shadow" href="/translatoraid/"""+book.replace(" ","")+".html"+"""">""" +book+"</a></span>" for book in books[21:] ])+ """
</p></div>
