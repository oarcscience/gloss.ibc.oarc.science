...
templatep="""<span id="word"><div id="{}"><ol class="word"><li lang=he><a href="/w/" target="_blank">{}</a></li><li title="" lang=en_MORPH>{}<span style="font-variant:small-caps;font-size:114%;"></span></li><li lang=en_MORPH><sup style="color: lightgray;"></sup>{}</li></ol></div></span><connection from="#{}" to="#{}" tail></connection>"""
...
<link rel="stylesheet" type="text/css" href="../css/domarrow.css" />
...
<script type="text/javascript" src="../css/domarrow.js"></script>
