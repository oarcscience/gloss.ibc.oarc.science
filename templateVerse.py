...
<p><span class="marginnote"><!---<a href="https://biblehub.com/bsb/" target="_blank"><i>BSB</i></a> ---><span style="color:white;">Debug: verse number {number}</span></span>{trtext_prepared}</p><p id="tr">/{words}/</p>
